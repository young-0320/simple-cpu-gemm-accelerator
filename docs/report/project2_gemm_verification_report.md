...
| `system_v2` | `20260607_222728_system_v2` | 1 | 18/18 PASS | PASS | `sim/results/system_v2/20260607_222728_system_v2/report.md` |
...
대표 waveform은 같은 검증 명령에 `--trace-fst`를 추가해 생성한다.
