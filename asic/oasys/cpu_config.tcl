namespace eval config {
    ...
    set input(verilog_files)                  {/mnt/NewHDD/home/ddl2023_1/ddl2023_2023100000/ddl2026_folder/cpu.sv}
    set input(verilog_dirs)                   {}
    set input(verilog_defs)                   {}
    set input(top_module)                     {cpu}
    ...
    set input(sdc_files)                      {/mnt/NewHDD/home/ddl2023_1/ddl2023_2023100000/ddl2026_folder/clk.sdc}
    set input(def_files)                      {}
