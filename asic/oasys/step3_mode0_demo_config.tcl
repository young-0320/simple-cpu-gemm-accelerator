namespace eval config {
    ...
    # =========================================================
    # step3 mode0  (DEMO: BRAM reduced 4096 -> 256 words)
    #   Uses step3_demo.f, which points gemm_system_top.v at
    #   asic/demo_mem256/gemm_system_top.v (256-word memory) so the
    #   full CPU+GEMM+memory system is small enough to place & route.
    # =========================================================
    set STEP       {step3}
    set TOP_MODULE {step3_system_top_mode0}
    # =========================================================

    # NOTE: read step3_demo.f instead of step3.f
    set FILELIST "$REPO_ROOT/asic/oasys/${STEP}_demo.f"
