namespace eval config {
    ...
    set input(verilog_dirs)                   [list "$REPO_ROOT/rtl/gemm_accelerator"]
    ...
    set input(vcd_file)                       "$REPO_ROOT/sim/results/power/step2_mode1_directed006/tb_gemm_vectors_single.vcd"
