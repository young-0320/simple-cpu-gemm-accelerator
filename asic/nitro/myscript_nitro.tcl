...
read_verilog /mnt/NewHDD/home/ddl2023_1/ddl2023_2023100000/ddl2026_folder/cpu_synth.v 
...
create_floorplan_regions -partition cpu -min_cells 0 -max_cells 1000000000 -min_area_percent 1 -max_area_percent 100 -core_cell_util 70
...
#run after pause
create_rows -partition cpu -core_site CORE -orient north -start_from core -gap 50a -xl_margin 0a -yb_margin 0a -xr_margin 0a -yt_margin 0a
#run after pause
config_route_global -category user_defined

config_route_global -name gr_full_timing_update_thresh -value 0.0

read_constraint clk.sdc
# run after pause
run_place_timing -effort high
# run after pause
run_clock_timing
# run after pause
run_route_timing
#run after pause
write_sdf cpu.sdf -skip_backslash true

write_verilog -file "cpu_synth_nitro.v"
