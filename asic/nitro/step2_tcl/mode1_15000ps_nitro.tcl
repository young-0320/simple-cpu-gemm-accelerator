...
set MODE       {mode1}
set PERIOD     {15000ps}
set TOP_MODULE {step2_gemm_accelerator_top_mode1}
# =========================================================
...
# =========================================================
# chip area
create_chip -xl_area 0a -yb_area 0a -xr_area 6300000a -yt_area 6300000a -core_site CORE -xl_margin 0a -yt_margin 0a -orient north -double_backed true -gap 0a
# =========================================================
...
read_constraint "$REPO_ROOT/asic/nitro/${STEP}_tcl/${MODE}_${PERIOD}.sdc"
# run after pause
