...
module gemm_mac_datapath (
    ...
    // c_rdata unused: 1-MAC accumulates in an internal register, so it
    // never reads back c_buf. Port kept for interface symmetry with the
    // buffer's read port.
